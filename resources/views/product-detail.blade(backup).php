                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                @auth
                                    <form id="payment-form" class="flex-1">
                                        ...
                                        <button type="button" id="pay-button" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg transition-colors font-medium flex items-center justify-center">
                                    ...
                                    <select name="payment_method" id="payment_method" class="mb-4 w-full border rounded px-3 py-2">
                                        @php
                                            $paymentMethods = [
                                                'gopay' => 'GoPay',
                                                'shopeepay' => 'ShopeePay',
